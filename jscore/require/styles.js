...
//
/* jshint ignore:start */
define('jscore/less/less', function () {
...
define('styles',['jscore/less/less', 'PluginInterface'], function (lessc, PluginInterface) {
    'use strict';

    return PluginInterface.extend({

        parse: function(name, content, config) {
            var lessParser = new lessc.Parser();
            ...
            lessParser.parse(currentUrl + resourcesUrl + content, function (err, tree) {
                if (err) {
        ...
        write: function(name, content, config) {
            return "define(function () { return '"+this.jsEscape(content)+"';});\n";
        }
